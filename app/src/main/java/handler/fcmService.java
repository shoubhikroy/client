...
public class fcmService extends FirebaseMessagingService
{
    ...
    public void onMessageReceived(RemoteMessage remoteMessage)
    {
        ...
        // When the Setting taps on the notification they are returned to the app. Messages containing both notification
        ...
        if (remoteMessage.getData().size() > 0)
        {
            ...
            int x = 0;
            x++;
            for (String datsa : data.keySet())
            {
                String dadad = data.get(datsa);
            }
